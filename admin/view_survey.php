...
$public_link = isset($data['token']) && $data['token']
    ? "../public/view_survey.php?token=" . $data['token']
    : null;
...
<head>
    <meta charset="UTF-8">
    <title>Survey Details (Admin View)</title>
...
<body>
    <div class="container mt-4">
                        ...
                        <div class="card-body row g-2">
                            ...
                            <?php if (!empty($inv['pic'])): ?>
                                <div class="col-md-3">
                                    ...
                                    <img src="../uploads/<?= htmlspecialchars($inv['pic']) ?>" alt="Inverter Pic"
        ...
        <!-- Battery Details -->
        <?php $batteries = json_decode($data['battery_details'] ?? '[]', true);
        if (!empty($batteries)): ?>
            <div class="form-section">
